...
- `src/main/java/com/ticketmind`：应用主包，放 Spring Boot 启动类和项目核心代码。
...
- `src/main/resources`：放应用配置文件，例如 `application.yml`。
- `src/test/java/com/ticketmind`：放测试代码，测试包结构应尽量和主代码包结构一致。
